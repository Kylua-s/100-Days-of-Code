...
# Game continuous
    ...
    # Game continuous
        ...
        way = input("You arrive at the island unharmed. There is a house with 3 doors. One red, one yellow and one blue. Which color do you choose? Type 'red', 'blue' or 'yellow'\n")
        if way == 'red':
